...
//Match entity and bug fixing done
@Entity
public class Match {
	@Id
	...
	public void setNeutralVenue(String neutral_venue) {
		this.neutralVenue = neutral_venue;
	}
	...
	public void setTossDecision(String toss_decision) {
		this.tossDecision = toss_decision;
	}
