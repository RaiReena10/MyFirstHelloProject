...
public class BatchConfig {
	...
	String fields[] = new String[] { "id","city","date","player_of_match","venue","neutral_venue","team1","team2","toss_winner","toss_decision","winner","result","result_margin","eliminator","method","umpire1","umpire2"
	...
	public FlatFileItemReader<Matchinput> reader() {
		return new FlatFileItemReaderBuilder<Matchinput>().name("personItemReader")
				.resource(new ClassPathResource("IPL.csv")).delimited().names(fields)
